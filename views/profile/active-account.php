				...
				<div class="login-content">
					<form>
						<div class="section-title">
							<h3>Congratulations on your registration and actived successful !</h3>
						</div>
					</form>
					<div class="forgot">
						<p>Please click to <a href="<?= \app\components\tona\Helper::siteURLAnd('login.html'); ?>">login</a>. <b>Thank you very much !</b></p>
					</div>
