...
$(document).ready(function(){
    var idContent = $("#news-content");
    if(idContent.length){
        CKEDITOR.replace("news-content");
    }

    var idContentA = $("#article-content");
    if(idContentA.length){
    ...
    $(".openFinder").on('click', function () {
        ...
        if($(this).attr('data-folder') == 'Files' || $(this).attr('data-folder') == 'Images'){
            finder.resourceType = $(this).attr('data-folder');
        }
...
$(document).ready(function() {
    ...
    // Bar chart
    var mybarChartDiv = $('#mybarChart');
    if(mybarChartDiv.length > 0){
        ...
        var mybarChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [10,20,30,40,50,60,70,0,0,0,0,0]
                }, {
                    label: 'Out',
                    backgroundColor: "#03586A",
                    data: [41, 56, 25, 48, 72, 34, 12,0,0,0]
                }]
            },
...
$(document).ready(function() {
    ...
    datetimepicker1.each(function(){
        var _this = $(this);
        var format = _this.attr('data-date-time-format');
        var value = _this.val();
